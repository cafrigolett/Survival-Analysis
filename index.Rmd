...
# Table of Contents
1. [Data set](#section1)
2. [Descriptive Analysis](#section5)
3. [Focusing on response variable, censoring indicator, and categorical variable ](#section3)
4. [Survival time different between treatment condition](#section4)
5. [Variable Selection](#section5)
6. [Parametric Model Selection](#section6)
